...
public class CosmosAsyncDatabaseManagedObjectSource extends AbstractManagedObjectSource<None, None>
	 ...
	 * @throws Exception If fails to create {@link CosmosAsyncDatabase}.
	 */
	public CosmosAsyncDatabase createCosmosAsyncDatabase(SourceContext sourceContext) throws Exception {
		this.database = CosmosDbConnect.createCosmosAsyncDatabase(sourceContext);
	...
	protected void loadMetaData(MetaDataContext<None, None> context) throws Exception {
		...
		// Obtain the database
		this.createCosmosAsyncDatabase(mosContext);
	}
