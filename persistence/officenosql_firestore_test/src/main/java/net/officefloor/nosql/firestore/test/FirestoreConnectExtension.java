 ...
 */
public class FirestoreConnectExtension extends AbstractFirestoreConnectJunit
	 ...
	 */
	public FirestoreConnectExtension() {
	}
	 ...
	 */
	public FirestoreConnectExtension(Configuration configuration) {
		super(configuration);
	}
