...
import net.officefloor.web.response.HttpResponder;
...
public class WebArchitectEmployer implements WebArchitect {
    ...
    public void informOfficeArchitect() {
        ...
        // Create the HttpResponder
        HttpResponder httpResponder = new HttpResponder(this.objectResponderFactories, () -> this.defaultHttpObjectResponderServiceFactory != null
        ...
        NEXT_INTERCEPTOR:
        for (Class<?> interceptClass : this.officeSourceContext
            ...
            StringBuilder message = new StringBuilder();
            NEXT_OUTPUT:
            for (OfficeSectionOutputType outputType : interceptSectionType.getOfficeSectionOutputTypes()) {
        ...
        this.officeArchitect.addManagedFunctionAugmentor((context) -> {
            ...
            for (ManagedFunctionObjectType<?> functionParameterType : functionType.getObjectTypes()) {
                ...
                // Determine if ObjectResponse
                if (ObjectResponse.class.equals(objectType)) {
                    ...
                    ObjectResponseManagedObjectSource objectResponseMos = new ObjectResponseManagedObjectSource(httpResponder, httpStatus,
                            functionType, functionParameterType);
