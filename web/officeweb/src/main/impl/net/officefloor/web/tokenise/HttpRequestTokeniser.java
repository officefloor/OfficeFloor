...
public class HttpRequestTokeniser {
     ...
     * {@link ValueLoader}.
     *
     * @param request         {@link HttpRequest} to be tokenised.
     * @param valueLoader     {@link ValueLoader}.
     * @param argumentParsers {@link HttpArgumentParser} instances.
     * @throws HttpException If fails to tokenise the {@link HttpRequest}.
     */
     ...
     * @param valueLoader {@link ValueLoader}.
     * @throws HttpException If fails to tokenise the form content.
     */
    ...
    public static String decode(CharSequence value) {
        return decode(value, true, parseState.get());
    }
     ...
     * @param state {@link ParseState}.
     * @return Decoded text.
     * @throws HttpException If fails to translate.
     */
     ...
     * @throws HttpException If invalid character for escaping.
     */
