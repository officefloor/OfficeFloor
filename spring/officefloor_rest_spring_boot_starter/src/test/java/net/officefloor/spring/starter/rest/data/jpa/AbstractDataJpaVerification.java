...
public abstract class AbstractDataJpaVerification extends AbstractMockMvcVerification {
    ...
    public void existsById() throws Exception {
        this.mvc.perform(get(this.getPath("/users/User_1/exists")).accept(MediaType.APPLICATION_JSON))
    ...
    public void findById() throws Exception {
        this.mvc.perform(get(this.getPath("/users/id/User_1")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void findByName() throws Exception {
        this.mvc.perform(get(this.getPath("/users/name/User_1")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Description_1")));
    }
    ...
    public void findAll() throws Exception {
        this.mvc.perform(get(this.getPath("/users/all")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void countUsers() throws Exception {
        this.mvc.perform(get(this.getPath("/users/count")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("99")));
    }
    ...
    public void sortedUsers() throws Exception {
        this.mvc.perform(get(this.getPath("/users/sorted")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void customQuery() throws Exception {
        this.mvc.perform(get(this.getPath("/users/active/User_1")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Description_1")));
    }
    ...
    public void nativeSqlQuery() throws Exception {
        this.mvc.perform(get(this.getPath("/users/native/User_1")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Description_1")));
    }
    ...
    public void modifyingQuery() throws Exception {
        this.mvc.perform(post(this.getPath("/users/deactivate/User_1")).with(csrf()).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Deactivated: 1")));
        this.mvc.perform(get(this.getPath("/users/User_1/active")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void pagination() throws Exception {
        this.mvc.perform(get(this.getPath("/users?page=0&size=10")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void paginationNextPage() throws Exception {
        this.mvc.perform(get(this.getPath("/users?page=1&size=10")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("total=99, pages=10, size=10, elements=10")));
    }
    ...
    public void paginationLastPage() throws Exception {
        this.mvc.perform(get(this.getPath("/users?page=9&size=10")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void saveAll() throws Exception {
        this.mvc.perform(post(this.getPath("/users/batch")).with(csrf())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        this.mvc.perform(get(this.getPath("/userCount")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void deleteUser() throws Exception {
        this.mvc.perform(MockMvcRequestBuilders.delete(this.getPath("/users/delete/User_1")).with(csrf())
                        .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    public void derivedDelete() throws Exception {
        this.mvc.perform(MockMvcRequestBuilders.delete(this.getPath("/users/name/User_1")).with(csrf())
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
        this.mvc.perform(get("/users/count").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void updateUser() throws Exception {
        this.mvc.perform(MockMvcRequestBuilders.put(this.getPath("/users/update/User_1")).with(csrf())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"description\":\"Updated Description\"}"))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Updated Description")));
        this.mvc.perform(get(this.getPath("/users/description/User_1")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Updated Description")));
    }
    ...
    public void checkedExceptionNoRollback() throws Exception {
        this.mvc.perform(post(this.getPath("/saveAndFailChecked")).with(csrf()).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isInternalServerError());
        this.mvc.perform(get(this.getPath("/users/ount")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void pessimisticLock() throws Exception {
        this.mvc.perform(get(this.getPath("/users/locked/User_1")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("Description_1")));
    }
    ...
    public void projection() throws Exception {
        this.mvc.perform(get(this.getPath("/userProjection")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("User_1")));
    }
    ...
    public void auditingFields() throws Exception {
        this.mvc.perform(post(this.getPath("/users")).with(csrf())
                ...
                .andExpect(status().isCreated());
        this.mvc.perform(get(this.getPath("/users/audit/AuditedUser")).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
