...
public class OfficeModelRepositoryTest extends OfficeFrameTestCase {
	...
	public void testRetrieveOffice() throws Exception {
		...
		assertList(new String[] { "getOfficeGovernanceName" }, extMo.getOfficeGovernances(),
		...
		assertProperties(new OfficeManagedObjectSourceFlowToOfficeSectionInputModel("SECTION", "INPUT"),
		...
		assertList(new String[] { "getOfficeGovernanceName" }, mo.getOfficeGovernances(),
		...
		assertProperties(new OfficeEscalationToOfficeSectionInputModel("SECTION", "INPUT"),
		...
		assertList(new String[] { "getAdministrationName", "getAdministrationSourceClassName", "getX", "getY" },
				office.getOfficeAdministrations(), new AdministrationModel("ADMINISTRATION",
						"net.example.ExampleAdministrationSource", null, null, null, null, null, null, 600, 601));
		AdministrationModel admin = office.getOfficeAdministrations().get(0);
		...
		fail("TODO implement checks for flow linking");
		fail("TODO implement checks for escalation linking");

		// ----------------------------------------
		// Validate the governances
		// ----------------------------------------
		assertList(new String[] { "getOfficeGovernanceName", "getGovernanceSourceClassName", "getX", "getY" },
				office.getOfficeGovernances(),
				new OfficeGovernanceModel("GOVERNANCE", "net.example.ExampleGovernanceSource", null, null, null, null,
						null, null, null, null, 700, 701));
		...
		assertList(new String[] { "getX", "getY", "getHeight", "getWidth" }, gov.getOfficeGovernanceAreas(),
				new OfficeGovernanceAreaModel(720, 721, 710, 711));
		...
		assertProperties(new OfficeStartToOfficeSectionInputModel("SECTION", "INPUT"), start.getOfficeSectionInput(),
		...
		assertList(new String[] { "getOfficeGovernanceName" }, officeSection.getOfficeGovernances(),
		...
		assertList(new String[] { "getOfficeGovernanceName" }, officeSectionMo.getOfficeGovernances(),
				new OfficeSectionManagedObjectToOfficeGovernanceModel("GOVERNANCE"));
		...
		assertList(new String[] { "getOfficeGovernanceName" }, officeSectionFunction.getOfficeGovernances(),
				new OfficeFunctionToOfficeGovernanceModel("GOVERNANCE"));
		...
		assertList(new String[] { "getOfficeGovernanceName" }, subSectionFunction.getOfficeGovernances(),
				new OfficeFunctionToOfficeGovernanceModel("GOVERNANCE"));
