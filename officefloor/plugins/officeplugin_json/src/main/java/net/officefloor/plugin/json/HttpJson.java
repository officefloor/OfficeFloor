 ...
 * class to indicate it should be a {@link JsonRequestReaderManagedObjectSource}
 * that will load the JSON content onto the object.
 * <p>
 * This simplifies means to specifying
 * {@link JsonRequestReaderManagedObjectSource} instances by in-lining it with
 * the code.
 * 
