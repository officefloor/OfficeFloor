...
/**
 * {@link Extension} for connecting to local DynamoDb.
 * 
 * @author Daniel Sagenschneider
 */
public class DynamoDbConnectExtension extends AbstractDynamoDbConnectJunit
	 ...
	 */
	public DynamoDbConnectExtension(Configuration configuration) {
		super(configuration);
	}
