 ...
 */
public abstract class AbstractNewWizardRefactor<R extends Model> extends Wizard implements INewWizard {
	 ...
	 * Initiate.
	 * 
	 * @param editor {@link AbstractIdeEclipseEditor}.
	 */
	public AbstractNewWizardRefactor(AbstractAdaptedIdeEditor<R, ?, ?> editor) {
	...
	public boolean performFinish() {
		...
		IRunnableWithProgress op = (IProgressMonitor monitor) -> {
			try {
				AbstractNewWizardRefactor.this.doFinish(container, itemName, monitor);
			} catch (Throwable e) {
