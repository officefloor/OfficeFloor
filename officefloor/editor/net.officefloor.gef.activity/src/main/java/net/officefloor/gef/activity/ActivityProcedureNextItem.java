...
public class ActivityProcedureNextItem extends
	...
	@Override
	public Pane visual(ActivityProcedureNextModel model, AdaptedChildVisualFactoryContext<ActivityProcedureNextModel> context) {
	...
	protected void connections(List<IdeConnectionTarget<? extends ConnectionModel, ?, ?>> connections) {
		...
		// Section Input
//		connections.add(new IdeConnection<>(ActivityProcedureNextToActivitySectionInputModel.class)
//				.connectOne(s -> s.getActivitySectionInput(), c -> c.getActivityProcedureNext(),
//						ActivityProcedureNextEvent.CHANGE_WOOF_SECTION_INPUT)
//				.to(ActivitySectionInputModel.class)
//				.many(t -> t.getActivityProcedureNexts(), c -> c.getActivitySectionInput(),
//						ActivitySectionInputEvent.ADD_WOOF_PROCEDURE_NEXT, ActivitySectionInputEvent.REMOVE_WOOF_PROCEDURE_NEXT)
//				.create((s, t, ctx) -> {
...
//						ActivityProcedureNextEvent.CHANGE_WOOF_PROCEDURE)
//				.to(ActivityProcedureModel.class)
//				.many(t -> t.getActivityProcedureNexts(), c -> c.getActivityProcedure(),
//						ActivityProcedureEvent.ADD_WOOF_PROCEDURE_NEXT, ActivityProcedureEvent.REMOVE_WOOF_PROCEDURE_NEXT)
//				.create((s, t, ctx) -> {
...
//				}));
		...
		// Resource
//		connections.add(new IdeConnection<>(ActivityProcedureNextToActivityResourceModel.class)
//				.connectOne(s -> s.getActivityResource(), c -> c.getActivityProcedureNext(),
//						ActivityProcedureNextEvent.CHANGE_WOOF_RESOURCE)
//				.to(ActivityResourceModel.class)
//				.many(t -> t.getActivityProcedureNexts(), c -> c.getActivityResource(),
//						ActivityResourceEvent.ADD_WOOF_PROCEDURE_NEXT, ActivityResourceEvent.REMOVE_WOOF_PROCEDURE_NEXT)
//				.create((s, t, ctx) -> {
