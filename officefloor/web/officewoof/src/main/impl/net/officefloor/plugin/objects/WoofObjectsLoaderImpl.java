...
import net.officefloor.model.objects.WoofManagedObjectModel;
import net.officefloor.model.objects.TypeQualificationModel;
import net.officefloor.model.objects.WoofObjectSourceModel;
import net.officefloor.model.objects.WoofObjectsModel;
import net.officefloor.model.objects.WoofObjectsRepository;
import net.officefloor.model.objects.WoofSupplierModel;
