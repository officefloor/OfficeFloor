 ...
 */
public interface WebApplicationArchitect {
	...
	/**
	 * Adds a {@link HttpSecuritySource} for this {@link WebApplicationArchitect}.
	 *
	 * @param securityName
	 ...
	 */
	HttpUrlContinuation linkUri(String uri, OfficeSectionInput sectionInput);
	 ...
	 * @return {@link HttpUrlContinuation} to configure handling the URI.
	 */
	HttpUrlContinuation linkUri(String uri, HttpTemplateSection template);
	 ...
	 * <p>
	 * The {@link WebApplicationArchitect} functionality is always the first in the chain
