...
import net.officefloor.web.resource.file.HttpFileWriterFunction;
import net.officefloor.web.resource.file.HttpFileWriterManagedFunctionSource;
import net.officefloor.web.resource.file.HttpFileWriterFunction.HttpFileWriterFunctionDependencies;
