...
public class LinkHttpTemplateWriter implements HttpTemplateWriter {
	 ...
	 */
	public LinkHttpTemplateWriter(LinkHttpTemplateSectionContent content, String templateUriPath,
			String templateUriSuffix, boolean isLinkSecure) throws InvalidRequestUriHttpException {
		this.isLinkSecure = isLinkSecure;

		// Create the link URI path
		this.linkUriPath = HttpTemplateManagedFunctionSource.getHttpTemplateLinkUrlContinuationPath(templateUriPath,
	...
	public void write(ServerWriter writer, boolean isDefaultCharset, Object bean, ServerHttpConnection connection,
		...
		String clientLinkPath = applicationState.createApplicationClientUrl(this.isLinkSecure, this.linkUriPath,
				connection);
