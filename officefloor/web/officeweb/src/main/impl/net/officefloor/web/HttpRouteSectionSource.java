...
public class HttpRouteSectionSource extends AbstractSectionSource {
    ...
    public static class RouteInput {
        ...
        /**
         * Indicates if direct invocation.
         */
        private boolean isDirectInvocation = false;
         ...
         */
        public void flagDirectInvocation() {
            this.isDirectInvocation = true;
        }

        /**
         * Obtains the direct {@link net.officefloor.compile.spi.office.OfficeSectionInput} name.
         *
         * @return Direct {@link net.officefloor.compile.spi.office.OfficeSectionInput} name.
         */
        public String getDirectInputName() {
            return this.method.getName() + "_" + this.path;
        }
    }
    ...
    public void sourceSection(SectionDesigner designer, SectionSourceContext context) throws Exception {
        ...
        SectionFunctionNamespace routeNamespace = designer.addSectionFunctionNamespace("ROUTE",
                new HttpRouteManagedFunctionSource(this.routes, httpRouter));
    ...
    private class HttpRouteManagedFunctionSource extends AbstractManagedFunctionSource {
         ...
         * {@link RouteInput} instances.
         */
        private final List<RouteInput> routes;
         ...
         * Instantiate.
         *
         * @param routes {@link RouteInput} instances.
         * @param router {@link HttpRouter}.
         */
        private HttpRouteManagedFunctionSource(List<RouteInput> routes, HttpRouter router) {
            this.routes = routes;
            this.router = router;
        }
        ...
        public void sourceManagedFunctions(FunctionNamespaceBuilder functionNamespaceTypeBuilder,
            ...
            int handleRedirectFlowIndex = this.routes.size() + 1;
            ...
            this.router.configureRoutes(this.routes, builder);
