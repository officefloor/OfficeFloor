...
public class HttpParametersLoaderTest extends OfficeFrameTestCase {
	...
	public void testOnlyTypeParametersLoaded() throws Exception {
		...
		HttpRequest request = MockHttpServer
				.mockRequest("/path?FirstName=Daniel&LastName=Sagenschneider&Description=description&Ignore=NotLoaded")
				.build();
	...
	private void doTest(HttpMethod method, String requestUri, String requestEntity, boolean isCaseSensitive,
		...
		MockHttpRequestBuilder requestBuilder = MockHttpServer.mockRequest().method(method).uri(requestUri);
	...
	private HttpParametersLoader<MockInterface> createLoader(boolean isCaseSensitive, String... aliasProperties)
		...
		HttpParametersLoader<MockInterface> loader = new HttpParametersLoader<MockInterface>(MockInterface.class,
				aliasMappings, !isCaseSensitive, null);
