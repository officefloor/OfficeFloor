...
/**
 * Abstract tests for a polyglot {@link net.officefloor.activity.procedure.Procedure} via a {@link SectionSource}.
 *
...
public abstract class AbstractPolyglotProcedureTest extends OfficeFrameTestCase {
    ...
    /**
     * Convenience method to add a {@link net.officefloor.activity.procedure.Procedure}.
     *
     * @param resourceName   Name of resource.
     * @param serviceFactory {@link ProcedureServiceFactory}.
     * @param procedureName  Name of {@link net.officefloor.activity.procedure.Procedure}.
     * @param isNext         Indicates if next {@link net.officefloor.frame.internal.structure.Flow}.
     * @param context        {@link CompileOfficeContext}.
     * @return {@link }OfficeSection} for the {@link net.officefloor.activity.procedure.Procedure}.
     */
    protected OfficeSection addProcedure(String resourceName, Class<? extends ProcedureServiceFactory> serviceFactory, String procedureName, boolean isNext, CompileOfficeContext context) {

        // Load the service
        ProcedureService service = ProcedureLoaderUtil.loadProcedureService(serviceFactory);
    ...
    /**
     * Obtains the {@link ProcedureServiceFactory} {@link Class}.
     *
     * @return {@link ProcedureServiceFactory} {@link Class}.
     */
    ...
    protected interface ProcedureBuilder {
        ...
        /**
         * Convenience method to configure the {@link net.officefloor.activity.procedure.Procedure}.
         *
        ...
        /**
         * Specifies an override {@link ProcedureServiceFactory} {@link Class}.
         *
         * @param serviceFactoryClass Override {@link ProcedureServiceFactory} {@link Class}.
         */
        void setProcedureServiceFactoryClass(Class<? extends ProcedureServiceFactory> serviceFactoryClass);

        /**
         * Specifies the name of the {@link net.officefloor.activity.procedure.Procedure}.
         *
         * @param procedureName Name of the {@link net.officefloor.activity.procedure.Procedure}.
         */
        void setProcedureName(String procedureName);

        /**
         * Allows overriding {@link net.officefloor.frame.api.function.ManagedFunction} name derived from {@link net.officefloor.activity.procedure.Procedure} name.
         *
         * @param managedFunctionName Overriding {@link net.officefloor.frame.api.function.ManagedFunction} name.
         */
    ...
    private class ProcedureBuildImpl implements ProcedureBuilder {
        ...
        /**
         * {@link ProcedureServiceFactory} {@link Class}.
         */
         ...
         * @return {@link ProcedureServiceFactory} {@link Class}.
         */
        private Class<? extends ProcedureServiceFactory> getProcedureServiceFactory() {
            return this.serviceFactoryClass != null ? this.serviceFactoryClass : AbstractPolyglotProcedureTest.this.getProcedureServiceFactoryClass();
        }
        ...
        @Override
        public void setProcedureServiceFactoryClass(Class<? extends ProcedureServiceFactory> serviceFactoryClass) {
    ...
    protected String primitives(CompileOfficeContext context, OfficeSectionInput handleResult) {
        ProcedureBuildImpl builder = new ProcedureBuildImpl();
        this.primitives(builder);
        OfficeSection procedure = this.addProcedure(builder.getResource(), builder.getProcedureServiceFactory(), builder.getProcedureName(), true, context);
        context.getOfficeArchitect().link(procedure.getOfficeSectionOutput(ProcedureArchitect.NEXT_OUTPUT_NAME), handleResult);
    ...
    protected String collections(CompileOfficeContext context, OfficeSectionInput handleResult) {
        ProcedureBuildImpl builder = new ProcedureBuildImpl();
        this.collections(builder);
        OfficeSection procedure = this.addProcedure(builder.getResource(), this.getProcedureServiceFactoryClass(), builder.getProcedureName(), true, context);
        context.getOfficeArchitect().link(procedure.getOfficeSectionOutput(ProcedureArchitect.NEXT_OUTPUT_NAME), handleResult);
        return builder.getManagedFunctionName();
    }
    ...
    protected void web(OfficeFlowSourceNode pass, CompileWebContext context) {
        ProcedureBuildImpl builder = new ProcedureBuildImpl();
        this.web(builder);
        OfficeSection procedure = this.addProcedure(builder.getResource(), builder.getProcedureServiceFactory(), builder.getProcedureName(), false, context);
