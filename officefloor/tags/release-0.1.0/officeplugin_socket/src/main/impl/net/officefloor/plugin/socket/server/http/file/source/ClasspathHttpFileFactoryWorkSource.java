 ...
 */
public class ClasspathHttpFileFactoryWorkSource extends
		AbstractWorkSource<HttpFileFactoryTask> {
	...
	public void sourceWork(
			WorkTypeBuilder<HttpFileFactoryTask> workTypeBuilder,
		...
		HttpFileFactoryTask task = new HttpFileFactoryTask(httpFileFactory, -1);
