...
import net.officefloor.plugin.gwt.comet.section.PublishWorkSource.Dependencies;
import net.officefloor.plugin.gwt.comet.section.PublishWorkSource.PublishTask;
