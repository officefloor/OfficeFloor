...
public class ServerWriterTest extends OfficeFrameTestCase {
	 ...
	 */
	private final ServerWriter writer = new ServerWriterImpl(this.output.getServerOutputStream(),
			Charset.defaultCharset(), this);
	...
	private void assertWrittenContent(String expectedContent) {
		assertEquals("Incorrect written content", expectedContent, new String(this.output.getWrittenBytes()));
	}
