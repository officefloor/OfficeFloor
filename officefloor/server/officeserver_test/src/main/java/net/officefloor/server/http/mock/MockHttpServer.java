...
public class MockHttpServer implements HttpServerLocation, HttpServerImplementation {
    ...
    /**
     * Convenience method to extract {@link ExternalServiceInput} from {@link OfficeSectionInput}.
     *
     * @param input {@link OfficeSectionInput}.
     * @return {@link ExternalServiceInput}.
     */
    public static ExternalServiceInput<ServerHttpConnection, ProcessAwareServerHttpConnectionManagedObject<ByteBuffer>> getExternalServiceInput(OfficeSectionInput input) {
        ExternalServiceInput generic = input.addExternalServiceInput(ServerHttpConnection.class, ProcessAwareServerHttpConnectionManagedObject.class);
        return (ExternalServiceInput<ServerHttpConnection, ProcessAwareServerHttpConnectionManagedObject<ByteBuffer>>) generic;
    }

    /**
     * Convenience method to extract {@link ExternalServiceInput} from {@link DeployedOfficeInput}.
     *
     * @param input {@link DeployedOfficeInput}.
     * @return {@link ExternalServiceInput}.
     */
    public static ExternalServiceInput<ServerHttpConnection, ProcessAwareServerHttpConnectionManagedObject<ByteBuffer>> getExternalServiceInput(DeployedOfficeInput input) {
        ExternalServiceInput generic = input.addExternalServiceInput(ServerHttpConnection.class, ProcessAwareServerHttpConnectionManagedObject.class);
        return (ExternalServiceInput<ServerHttpConnection, ProcessAwareServerHttpConnectionManagedObject<ByteBuffer>>) generic;
    }
    ...
    /**
     * Triggers direct handling of {@link MockHttpRequestBuilder}.
     *
     * @param request              {@link MockHttpRequestBuilder}.
     * @param externalServiceInput {@link ExternalServiceInput} for direct invocation.
     * @param callback             {@link MockHttpRequestCallback} to receive the
     *                             {@link MockHttpResponse}.
     */
    public void direct(MockHttpRequestBuilder request, ExternalServiceInput<ServerHttpConnection, ProcessAwareServerHttpConnectionManagedObject<ByteBuffer>> externalServiceInput, MockHttpRequestCallback callback) {
        ...
        // Service the request
        externalServiceInput.service(connection, connection.getServiceFlowCallback());
    }
    ...
    /**
     * Undertakes direct invocation of servicing the {@link MockHttpRequestBuilder}.
     *
     * @param request              {@link MockHttpRequestBuilder}.
     * @param externalServiceInput {@link ExternalServiceInput} for direct invocation.
     * @return {@link MockHttpResponse}.
     */
    public MockHttpResponse direct(MockHttpRequestBuilder request, ExternalServiceInput<ServerHttpConnection, ProcessAwareServerHttpConnectionManagedObject<ByteBuffer>> externalServiceInput) {

        // Create the synchronous callback
        SynchronousMockHttpRequestCallback callback = new SynchronousMockHttpRequestCallback();

        // Direct invocation to service request
        this.direct(request, externalServiceInput, callback);
