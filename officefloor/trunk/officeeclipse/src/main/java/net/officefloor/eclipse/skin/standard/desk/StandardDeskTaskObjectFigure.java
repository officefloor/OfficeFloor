 ...
 * @author Daniel
 */
public class StandardDeskTaskObjectFigure extends AbstractOfficeFloorFigure
		implements DeskTaskObjectFigure {
	 ...
	 */
	public StandardDeskTaskObjectFigure(DeskTaskObjectFigureContext context) {
