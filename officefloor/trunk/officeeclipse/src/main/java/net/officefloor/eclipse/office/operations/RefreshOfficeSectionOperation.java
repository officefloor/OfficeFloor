 ...
 * @author Daniel
 */
public class RefreshOfficeSectionOperation extends AbstractOperation<OfficeSectionEditPart> {

	/**
	 * Initiate.
	 */
	public RefreshOfficeSectionOperation() {
		super("Refresh room", OfficeSectionEditPart.class);
	}
