...
/**
 * Property for the {@link ManagedObjectSource}.
 * 
 * @author Daniel
 */
public class InitiateProperty {
	 ...
	 */
	public InitiateProperty(String name, String value) {
		this.name = name;
		this.setValue(value);
	}
	 ...
	 *            Name of the property.
	 */
	public InitiateProperty(String name) {
		this(name, null);
	}
