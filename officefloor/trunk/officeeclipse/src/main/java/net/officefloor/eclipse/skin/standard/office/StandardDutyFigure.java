...
public class StandardDutyFigure extends AbstractOfficeFloorFigure implements
	...
	public StandardDutyFigure(DutyFigureContext context) {
		...
		this.registerConnectionAnchor(FlowItemToPreAdministratorDutyModel.class, anchor);
		this.registerConnectionAnchor(FlowItemToPostAdministratorDutyModel.class, anchor);
