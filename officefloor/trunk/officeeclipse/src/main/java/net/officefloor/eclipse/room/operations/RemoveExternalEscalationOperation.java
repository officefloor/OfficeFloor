...
public class RemoveExternalEscalationOperation
		extends
		AbstractRemoveItemModelOperation<ExternalEscalationEditPart, ExternalEscalationModel, RoomModel> {
	 ...
	 */
	@Override
	protected void remove(ExternalEscalationModel model, RoomModel parent) {
	 ...
	 */
	@Override
	protected void unremove(ExternalEscalationModel model, RoomModel parent) {
