...
public class RemoveExternalFlowOperation
		extends
		AbstractRemoveItemModelOperation<ExternalFlowEditPart, ExternalFlowModel, DeskModel> {

	/**
	 * Initiate.
	 */
	public RemoveExternalFlowOperation() {
		super("Remove external flow item", ExternalFlowEditPart.class);
	}
	 ...
	 */
	@Override
	protected void remove(ExternalFlowModel model, DeskModel parent) {
	 ...
	 */
	@Override
	protected void unremove(ExternalFlowModel model, DeskModel parent) {
