...
/**
 * Refreshes the {@link SubSectionModel}.
 * 
 * @author Daniel
 */
public class RefreshSubSectionOperation extends AbstractOperation<SubSectionEditPart> {

	/**
	 * Initiate.
	 */
	public RefreshSubSectionOperation() {
		super("Refresh sub room", SubSectionEditPart.class);
	}
