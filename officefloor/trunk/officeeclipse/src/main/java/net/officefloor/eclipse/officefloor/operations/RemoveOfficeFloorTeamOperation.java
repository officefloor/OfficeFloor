 ...
 * @author Daniel
 */
public class RemoveOfficeFloorTeamOperation
		extends
		AbstractRemoveItemModelOperation<OfficeFloorTeamEditPart, OfficeFloorTeamModel, OfficeFloorModel> {

	/**
	 * Initiate.
	 */
	public RemoveOfficeFloorTeamOperation() {
		super("Remove team", OfficeFloorTeamEditPart.class);
	}
