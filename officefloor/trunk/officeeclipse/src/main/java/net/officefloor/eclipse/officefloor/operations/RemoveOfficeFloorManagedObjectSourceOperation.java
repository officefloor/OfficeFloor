 ...
 * @author Daniel
 */
public class RemoveOfficeFloorManagedObjectSourceOperation
		extends
		AbstractRemoveItemModelOperation<OfficeFloorManagedObjectSourceEditPart, OfficeFloorManagedObjectSourceModel, OfficeFloorModel> {

	/**
	 * Initiate.
	 */
	public RemoveOfficeFloorManagedObjectSourceOperation() {
		super("Remove managed object source", OfficeFloorManagedObjectSourceEditPart.class);
	}
