...
/**
 * Standard {@link DeskWorkFigure}.
 * 
 * @author Daniel
 */
public class StandardDeskWorkFigure extends AbstractOfficeFloorFigure implements
		DeskWorkFigure {
	 ...
	 */
	public StandardDeskWorkFigure(DeskWorkFigureContext context) {
