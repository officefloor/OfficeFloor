 ...
 * @author Daniel
 */
public class StandardExternalTeamFigure extends AbstractOfficeFloorFigure
		implements ExternalTeamFigure {
	 ...
	 */
	public StandardExternalTeamFigure(ExternalTeamFigureContext context) {
