 ...
 * @author Daniel
 */
public class SubRoomInputFlowFigureImpl extends OfficeFloorFigureImpl implements
		SubRoomInputFlowFigure {
	 ...
	 *            Public {@link CheckBox}.
	 */
	public SubRoomInputFlowFigureImpl(IFigure figure, CheckBox checkBox) {
		super(figure);
