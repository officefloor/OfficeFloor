 ...
 * @author Daniel
 */
public class RemoveDeployedOfficeOperation
		extends
		AbstractRemoveItemModelOperation<DeployedOfficeEditPart, DeployedOfficeModel, OfficeFloorModel> {

	/**
	 * Initiate.
	 */
	public RemoveDeployedOfficeOperation() {
		super("Remove office", DeployedOfficeEditPart.class);
	}
