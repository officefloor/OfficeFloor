...
import net.officefloor.plugin.socket.server.http.session.generator.UuidHttpSessionIdGenerator;
...
import net.officefloor.plugin.socket.server.http.session.store.MemoryHttpSessionStore;
