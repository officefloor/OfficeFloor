...
import net.officefloor.plugin.server.socket.impl.SocketListener.SocketListenerDependencies;
...
public abstract class AbstractServerSocketManagedObjectSource<F extends Enum<F>>
	...
	protected void loadMetaData(MetaDataContext<None, F> context)
		...
		BufferSquirtFactory bufferSquirtFactory = new BufferSquirtFactory() {
			@Override
