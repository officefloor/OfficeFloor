...
public class HttpRequestParser {
	 ...
	 *
	 * @param nextByte
	 *            Next byte from the client.
	 * @return <code>true</code> if HTTP request is fully received from client.
	 * @throws ParseException
	 *             If fails to parse HTTP request.
	 */
	public boolean parseMoreContent(byte nextByte) throws ParseException {

		byte character = nextByte;
		...
		case BODY_CR:
			...
			if (contentLengthValue != null) {
				...
				try {
					this.contentLength = Integer.parseInt(contentLengthValue);
