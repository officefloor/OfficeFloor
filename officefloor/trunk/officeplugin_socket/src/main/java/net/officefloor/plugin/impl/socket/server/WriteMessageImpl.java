...
/**
 * Implementation of {@link WriteMessage}.
 * 
 * @author Daniel
 */
class WriteMessageImpl extends AbstractMessage<WriteMessageImpl> implements
		WriteMessage {
	 ...
	 */
	WriteMessageImpl(Stream<WriteMessageImpl> stream,
