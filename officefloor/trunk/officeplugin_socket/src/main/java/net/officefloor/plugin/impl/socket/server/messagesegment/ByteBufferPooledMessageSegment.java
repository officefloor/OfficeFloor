...
/**
 * {@link MessageSegment} that is be pooled.
 * 
 * @author Daniel Sagenschneider
 */
class ByteBufferPooledMessageSegment extends AbstractMessageSegment {
	 ...
	 *            {@link ByteBuffer}.
	 */
	public ByteBufferPooledMessageSegment(ByteBuffer buffer) {
		super(buffer);
	}
