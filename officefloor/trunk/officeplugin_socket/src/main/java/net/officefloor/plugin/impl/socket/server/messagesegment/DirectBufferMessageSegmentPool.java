...
/**
 * Pool of {@link MessageSegment} instances.
 * 
 * @author Daniel
 */
public class DirectBufferMessageSegmentPool implements MessageSegmentPool {
	...
	private ByteBufferPooledMessageSegment createMessageSegment() {
		return new ByteBufferPooledMessageSegment(ByteBuffer
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.officefloor.plugin.impl.socket.server.MessageSegmentPool#getMessageSegmentBufferSize()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.officefloor.plugin.impl.socket.server.MessageSegmentPool#getMessageSegment(java.nio.ByteBuffer)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.officefloor.plugin.impl.socket.server.MessageSegmentPool#getMessageSegment()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.officefloor.plugin.impl.socket.server.MessageSegmentPool#returnMessageSegments(net.officefloor.plugin.impl.socket.server.PooledMessageSegment)
	 */
	@Override
