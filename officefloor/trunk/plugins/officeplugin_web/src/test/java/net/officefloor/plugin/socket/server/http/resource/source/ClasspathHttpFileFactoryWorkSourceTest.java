...
import net.officefloor.plugin.socket.server.http.resource.AbstractHttpResourceFactoryTestCase;
import net.officefloor.plugin.socket.server.http.resource.ClasspathHttpResourceFactory;
import net.officefloor.plugin.socket.server.http.resource.HttpDirectory;
...
import net.officefloor.plugin.socket.server.http.resource.source.ClasspathHttpFileFactoryWorkSource.HttpFileFactoryTaskFlows;
...
public class ClasspathHttpFileFactoryWorkSourceTest extends OfficeFrameTestCase {
	...
	public void testType() {
		...
		// Provide task type
		TaskTypeBuilder<DependencyKeys, HttpFileFactoryTaskFlows> taskBuilder = workBuilder
