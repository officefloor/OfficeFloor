...
/**
 * Tests the {@link ServletServerInputStream}.
 * 
 * @author Daniel Sagenschneider
 */
@Ignore("TODO tidy up for working with Servlet 3.0 - i.e. take advantage of asynchronous requests")
public class ServletServerInputStreamTest extends OfficeFrameTestCase {
	...
	/**
	 * TODO implement tests (to write to backing {@link InputStream}).
	 */
	public void test_TODO_implement() {
		fail("TODO implement tests for "
				+ ServletServerInputStream.class.getSimpleName());
	}
	...
	// isClosed[0] = false;
	// InputBufferStream buffer = new ServletServerInputStream(
	// new InputStream() {
	// @Override
	...
	// */
	// private static void assertContent(String expectedContent, ByteBuffer
	// buffer) {
	...
	// */
	// private static void assertContent(String expectedContent, InputStream
	// stream) {
	// try {
	...
	// return new ServletServerInputStream(inputStream);
	// }
	//
	// /**
