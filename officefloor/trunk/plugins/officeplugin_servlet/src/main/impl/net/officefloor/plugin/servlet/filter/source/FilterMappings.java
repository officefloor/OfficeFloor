...
public class FilterMappings {
	...
	public void outputProperties(PropertyList properties) {
		...
		for (FilterMapping mapping : this.mappings) {
			...
			properties
					.addProperty(
							FilterChainFactoryManagedObjectSource.PROPERTY_FILTER_MAPPING_INDEX_PREFIX
			...
			if (urlPattern != null) {
				properties
						.addProperty(
								FilterChainFactoryManagedObjectSource.PROPERTY_FILTER_MAPPING_URL_PREFIX
			...
			if (servletName != null) {
				properties
						.addProperty(
								FilterChainFactoryManagedObjectSource.PROPERTY_FILTER_MAPPING_SERVLET_PREFIX
			...
			if ((types != null) && (types.length > 0)) {
				...
				properties
						.addProperty(
								FilterChainFactoryManagedObjectSource.PROPERTY_FILTER_MAPPING_TYPE_PREFIX
										+ index)
