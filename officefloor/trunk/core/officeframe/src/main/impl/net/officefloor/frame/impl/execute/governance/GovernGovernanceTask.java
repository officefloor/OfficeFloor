 ...
 */
public class GovernGovernanceTask<F extends Enum<F>> implements
	...
	public Object doTask(
		...
		// Obtain the active governance control
		ActiveGovernanceControl<F> governanceControl = (ActiveGovernanceControl<F>) context
				.getObject(GovernanceTaskDependency.GOVERNANCE_CONTROL);

		// Govern the managed object
		governanceControl.governManagedObject(context);
