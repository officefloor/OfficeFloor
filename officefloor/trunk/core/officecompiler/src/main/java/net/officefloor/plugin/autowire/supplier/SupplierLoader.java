...
import net.officefloor.plugin.autowire.spi.supplier.source.SupplierSource;
import net.officefloor.plugin.autowire.spi.supplier.source.SupplierSourceProperty;
import net.officefloor.plugin.autowire.spi.supplier.source.SupplierSourceSpecification;
