...
import net.officefloor.model.office.OfficeInputManagedObjectDependencyToOfficeManagedObjectModel.OfficeInputManagedObjectDependencyToOfficeManagedObjectEvent;
 ...
 */
public class OfficeInputManagedObjectDependencyToOfficeManagedObjectEditPart
		extends
		AbstractOfficeFloorConnectionEditPart<OfficeInputManagedObjectDependencyToOfficeManagedObjectModel, OfficeInputManagedObjectDependencyToOfficeManagedObjectEvent>
		implements
		OfficeInputManagedObjectDependencyToOfficeManagedObjectFigureContext {
