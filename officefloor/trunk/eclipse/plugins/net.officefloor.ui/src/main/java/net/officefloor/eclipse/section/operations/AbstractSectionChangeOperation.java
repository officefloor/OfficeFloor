...
/**
 * Abstract {@link SectionChanges} {@link Operation}.
 * 
 * @author Daniel Sagenschneider
 */
public abstract class AbstractSectionChangeOperation<E extends EditPart> extends
		AbstractOperation<E> {
	...
	public AbstractSectionChangeOperation(String actionText,
			Class<E> editPartType, SectionChanges sectionChanges) {
	...
	protected void perform(Context context) {
		...
		// Obtain the change
		final Change<?> change = this.getChange(this.sectionChanges, context);
		if (change == null) {
	 ...
	 * @return {@link Change}.
	 */
	protected abstract Change<?> getChange(SectionChanges changes, Context context);
