<jsp:useBean id="RequestBean" scope="request" class="net.officefloor.tutorial.servletfilterjspintegration.RequestBean" />
<jsp:useBean id="SessionBean" scope="session" class="net.officefloor.tutorial.servletfilterjspintegration.SessionBean" />
