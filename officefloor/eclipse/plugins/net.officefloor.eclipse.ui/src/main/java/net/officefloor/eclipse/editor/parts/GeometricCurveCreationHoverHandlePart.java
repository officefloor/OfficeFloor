...
public class GeometricCurveCreationHoverHandlePart extends AbstractLogoHoverHandlePart<HoverOverlayImageView> {
	...
	protected HoverOverlayImageView doCreateVisual() {
		URL overlayImageResource = GeometricElementDeletionHandlePart.class.getResource(IMG_ADD);
		...
		URL baseImageResource = GeometricElementDeletionHandlePart.class.getResource(IMG_ADD_DISABLED);
