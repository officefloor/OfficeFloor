...
public class AdaptedChildPart<M extends Model, A extends AdaptedChild<M>> extends AbstractAdaptedPart<M, A, Pane>
		implements ViewFactoryContext {

	/**
	 * {@link ChildrenGroupVisual} instances for the {@link ChildrenGroup}
	 * instances.
	 */
	...
	/**
	 * Obtains the {@link Pane} for the {@link ChildrenGroup}.
	 * 
	 * @param childrenGroup
	 *            {@link ChildrenGroup}.
	 * @return {@link Pane}.
	...
	/**
	 * {@link ChildrenGroup} visual.
	 */
	private static class ChildrenGroupVisual {

		/**
		 * {@link Pane} for the {@link ChildrenGroup}.
		 */
