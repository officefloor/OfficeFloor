 ...
 */
public interface ChildGroupBuilder {
	 ...
	 *         {@link Model}.
	 */
	<M extends Model, E extends Enum<E>> AdaptedChildBuilder<M, E> addChild(Class<M> modelClass,
			ViewFactory<M, AdaptedChild<M>> viewFactory);
