...
public class HttpSecuritySourceInstance extends AbstractCompilerIssues implements HttpSecuritySourceExtensionContext {
	...
	/**
	 * {@link HttpSecuritySourceExtension}. May be <code>null</code> if not obtained
	 * via extension point.
	 */
	...
	/**
	 * Loads the particular {@link SecurityInstance} for this
	 * {@link HttpSecuritySourceInstance} to configure properties from.
	 * 
	 * @param securityInstance
	 *            {@link SecurityInstance}.
	 */
	public void loadSecurityInstance(SecurityInstance securityInstance) {
	...
	/**
	 * Obtains the {@link PropertyList} to configure the {@link HttpSecuritySource}.
	 * 
	...
	public void createControls(Composite page) {
		...
		// Load Security instance properties if available
		if (this.securityInstance != null) {
			for (Property property : this.securityInstance.getPropertylist()) {
	 ...
	 * @return {@link HttpSecuritySource} class or <code>null</code> if not able to
	 *         load.
	 */
