...
import net.officefloor.plugin.web.http.resource.source.HttpFileFactoryManagedFunctionSource;
import net.officefloor.plugin.web.http.resource.source.SourceHttpResourceFactory;

/**
 * {@link ManagedFunctionSourceExtension} for the
 * {@link HttpFileFactoryManagedFunctionSource}.
 * 
 * @author Daniel Sagenschneider
 */
public class HttpFileFactoryManagedFunctionSourceExtension
		extends AbstractSocketManagedFunctionSourceExtension<HttpFileFactoryManagedFunctionSource> {

	/**
	 * Initiate.
	 */
	public HttpFileFactoryManagedFunctionSourceExtension() {
		super(HttpFileFactoryManagedFunctionSource.class, "Get Http File");
	}
	...
	public String getFunctionDocumentation(FunctionDocumentationContext context) throws Throwable {
		...
		return "Returns the " + HttpFile.class.getSimpleName()
