...
public class WoofSectionOutputEditPart
		extends AbstractOfficeFloorEditPart<WoofSectionOutputModel, WoofSectionOutputEvent, SectionOutputFigure>
	...
	@Override
	protected void handlePropertyChange(WoofSectionOutputEvent property, PropertyChangeEvent evt) {
		switch (property) {
		case CHANGE_WOOF_SECTION_OUTPUT_NAME:
			this.getOfficeFloorFigure().setSectionOutputName(this.getCastedModel().getWoofSectionOutputName());
			break;
