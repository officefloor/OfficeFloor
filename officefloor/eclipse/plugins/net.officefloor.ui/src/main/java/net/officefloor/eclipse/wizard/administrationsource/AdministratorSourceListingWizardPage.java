...
public class AdministratorSourceListingWizardPage extends WizardPage {
	 ...
	 */
	private final AdministrationSourceInstance[] administratorSourceInstances;
	...
	AdministratorSourceListingWizardPage(
			AdministrationSourceInstance[] administratorSourceInstances) {
	 ...
	 * 
	 * @return Selected {@link AdministrationSourceInstance} or <code>null</code>
	 *         if not selected.
	 */
	public AdministrationSourceInstance getSelectedAdministratorSourceInstance() {
