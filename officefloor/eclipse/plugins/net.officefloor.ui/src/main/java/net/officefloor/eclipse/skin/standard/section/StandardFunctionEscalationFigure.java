 ...
 */
public class StandardFunctionEscalationFigure extends AbstractOfficeFloorFigure implements FunctionEscalationFigure {
	 ...
	 */
	public StandardFunctionEscalationFigure(FunctionEscalationFigureContext context) {
		...
		LabelConnectorFigure figure = new LabelConnectorFigure(simpleType, ConnectorDirection.EAST,
				StandardOfficeFloorColours.BLACK());
		this.registerConnectionAnchor(FunctionEscalationToFunctionModel.class, figure.getConnectionAnchor());
		this.registerConnectionAnchor(FunctionEscalationToExternalFlowModel.class, figure.getConnectionAnchor());
