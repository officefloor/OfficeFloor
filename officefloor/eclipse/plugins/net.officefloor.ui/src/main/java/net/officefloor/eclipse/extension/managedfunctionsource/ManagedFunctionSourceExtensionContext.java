...
/**
 * Context for the {@link ManagedFunctionSourceExtension}.
 * 
 * @author Daniel Sagenschneider
 */
public interface ManagedFunctionSourceExtensionContext {
	 ...
	 * instances for the {@link ManagedFunctionSource} are to be done on this
	 * {@link PropertyList}.
	 * <p>
	 * The {@link PropertyList} may be in any state:
	 * <ol>
	 * <li>no value {@link PropertyList} populated from the
	 * {@link ManagedFunctionSourceSpecification} (creating a
	 * {@link FunctionNamespaceModel})</li>
	 * <li>any changed state based on editing of the
	 * {@link FunctionNamespaceModel} (editing
	 * {@link FunctionNamespaceModel})</li>
	 * </ol>
	 * 
	 ...
	 * {@link FunctionNamespaceType} from the {@link ManagedFunctionSource} with
	 * the {@link PropertyList}.
	 */
	 ...
	 * 
	 * @return {@link ClassLoader} for adding the {@link ManagedFunctionSource}.
	 */
