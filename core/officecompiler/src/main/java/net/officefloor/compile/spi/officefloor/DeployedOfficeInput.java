...
public interface DeployedOfficeInput extends OfficeFloorFlowSinkNode {
    ...
    /**
     * Obtains the name of the {@link net.officefloor.compile.spi.office.OfficeSection} containing the {@link DeployedOfficeInput}.
     *
     * @return Name of the {@link net.officefloor.compile.spi.office.OfficeSection} containing the {@link DeployedOfficeInput}.
     */
    String getDeployedOfficeSectionName();
