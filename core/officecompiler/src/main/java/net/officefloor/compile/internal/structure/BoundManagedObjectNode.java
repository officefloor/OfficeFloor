...
public interface BoundManagedObjectNode extends LinkObjectNode, GovernerableManagedObject, AdministerableManagedObject {
    ...
    /**
     * Builds the {@link ManagedObject} onto the {@link ManagedFunctionNode}.
     *
     * @param functionObjectName Name of the object on the {@link ManagedFunctionNode}.
     * @param functionBuilder    {@link ManagedFunctionBuilder}.
     * @param office             {@link OfficeNode} of the {@link Office} that this
     *                           {@link ManagedObject} is to build itself into.
     * @param officeBindings     {@link OfficeBindings}.
     * @param compileContext     {@link CompileContext}.
     * @return <code>true</code> if bound to {@link ManagedFunctionNode}.
     */
    boolean buildFunctionManagedObject(String functionObjectName, ManagedFunctionBuilder<?, ?> functionBuilder,
