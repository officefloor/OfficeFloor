...
public interface SectionNode extends Node, ManagedObjectRegistry, ManagedFunctionRegistry,
    ...
    /**
     * Removes the {@link SectionObjectNode} if unused.
     *
     * @param sectionObject {@link SectionObjectNode} to remove if unused.
     * @return <code>true</code> if removed.
     */
    boolean removeSectionObjectIfUnused(SectionObjectNode sectionObject);
