...
public abstract class AbstractCompileTestCase extends AbstractModelCompilerTestCase {
     ...
     * @param functionName       Name of the {@link ManagedFunction}.
     * @param officeTeamName     {@link Office} {@link Team} name.
     * @param isMethodAnnotation Indicates if {@link net.officefloor.plugin.section.clazz.MethodAnnotation}.
     * @return Added {@link ManagedFunctionBuilder}.
     */
    protected ManagedFunctionBuilder<?, ?> record_officeBuilder_addFunction(String namespace, String functionName,
                                                                            String officeTeamName, boolean isMethodAnnotation) {
        return this.compileTestSupport.record_officeBuilder_addFunction(namespace, functionName, officeTeamName, isMethodAnnotation);
    }
    ...
    /**
     * Add an {@link net.officefloor.plugin.section.clazz.MethodAnnotation} for the {@link ManagedFunction}.
     */
    protected void record_functionBuilder_addMethodAnnotation() {
        this.compileTestSupport.record_functionBuilder_addMethodAnnotation();
    }
