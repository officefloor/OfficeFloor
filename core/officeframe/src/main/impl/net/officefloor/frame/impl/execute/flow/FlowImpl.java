...
public class FlowImpl extends AbstractLinkedListSetEntry<Flow, ThreadState> implements Flow {
    ...
    public <O extends Enum<O>, F extends Enum<F>> ManagedFunctionContainer createManagedFunction(Object parameter,
        ...
        for (int i = 0; i < preAdministration.length; i++) {
            ...
            ManagedFunctionContainer adminFunction = this.createAdministrationFunction(
                    administrationMetaData.getAdministrationMetaData(), managedFunctionMetaData, administrationMetaData.getLogger(),
    ...
    public <E, F extends Enum<F>, G extends Enum<G>> ManagedFunctionContainer createAdministrationFunction(
        ...
        return this.createAdministrationFunction(adminMetaData.getAdministrationMetaData(), null, adminMetaData.getLogger(),
     ...
     * @param managedFunctionMetaData     {@link ManagedFunctionMetaData} of the {@link ManagedFunction} having {@link Administration}.
     ...
     * @param isUnloadResponsible         Whether the {@link Administration} is to
    ...
    private <E> ManagedFunctionContainer createAdministrationFunction(
            AdministrationMetaData<E, ?, ?> administrationMetaData, ManagedFunctionMetaData<?, ?> managedFunctionMetaData,
            Logger logger, ManagedObjectIndex[] requiredManagedObjects, boolean[] requiredGovernance,
            boolean isEnforceGovernance, BlockState parallelOwner,
        ...
        AdministrationFunctionLogic<E, ?, ?> administrationLogic = new AdministrationFunctionLogic<>(
                administrationMetaData, managedFunctionMetaData, extensions, logger);
