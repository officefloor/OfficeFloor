...
resource-aware scheduling of operating system level resources and only suggests
scheduling of application level resources via an API~\cite{capriccio}. 
Dependency capsules focus on isolation for better availability however they do
...
information for task sequencing to avoiding deadlocks rather than bottleneck
isolation.
