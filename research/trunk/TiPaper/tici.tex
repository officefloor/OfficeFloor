...
\begin{abstract}
TODO better elaborate:
  - Thread Injection allows decoupling the thread of control for a component
  - Continuation Injection allows decoupling the collaboration of components
  - Utilising these patterns with Dependency Injection enables an Inversion of Control pattern for building frameworks that enable bottom-up design and evolution of applications
