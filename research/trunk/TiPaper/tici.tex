...
containing the thread pool (web server application).  The web server continues
the processing by sending the HTTP response to the client web browser (another
