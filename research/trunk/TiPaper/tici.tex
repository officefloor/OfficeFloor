...
\lstset{caption=Example developer code of a method within a task for retrieving data from a cache\protect\footnotemark.  \texttt{CacheHandOffs} is the hand-off interface for the \texttt{retrieveData(\ldots)} method.}
