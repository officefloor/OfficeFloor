...
\begin{itemize}
  \item it's name (\texttt{componentId}) which is decoupled from the invoking higher \textsc{layer} component invocation (\texttt{contin\-uationId}) by \textsc{continuation injection};
