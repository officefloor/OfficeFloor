...
%%
%% While this document is not a program, it conveys the underlying design of OfficeFloor 
%% and as such any program derived from these ideas (in particular Thread Injection, 
%% Implicit Thread and Continuation Injection) is considered conveying OfficeFloor 
%% and is subject to the licensing of OfficeFloor. 
