...
%% this document (in particular Thread Injection, Implicit Thread and 
%% Continuation Injection) is considered conveying (copying/modifying) 
%% OfficeFloor and is therefore subject to the licensing of OfficeFloor. 
