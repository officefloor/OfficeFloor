...
improved performance tuning of applications for complex environments and enables
earlier and continuous delivery of working code for Agile methodologies.  The
improved performance tuning uses multiple thread pools to isolate the
performance impacts of the application in interacting with multiple downstream systems
(e.g. an application operating in a Service-Oriented Architecture).  The earlier
and continuous delivery of working code is enabled by inversion of control. 
...
applications reduces the lead times and refactoring of top-down software designs
to provide early and continuous delivery of working code for Agile
methodologies.
\end{abstract}
