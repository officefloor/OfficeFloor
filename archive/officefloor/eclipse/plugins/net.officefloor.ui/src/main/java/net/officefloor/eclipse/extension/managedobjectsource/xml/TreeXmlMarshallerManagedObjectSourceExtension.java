...
public class TreeXmlMarshallerManagedObjectSourceExtension
		implements ManagedObjectSourceExtension<None, None, TreeXmlMarshallerManagedObjectSource> {
	...
	public void createControl(Composite page, final ManagedObjectSourceExtensionContext context) {
		...
		Property property = context.getPropertyList()
				.getProperty(TreeXmlMarshallerManagedObjectSource.CONFIGURATION_PROPERTY_NAME);
		if (property == null) {
			property = context.getPropertyList()
					.addProperty(TreeXmlMarshallerManagedObjectSource.CONFIGURATION_PROPERTY_NAME);
		}
