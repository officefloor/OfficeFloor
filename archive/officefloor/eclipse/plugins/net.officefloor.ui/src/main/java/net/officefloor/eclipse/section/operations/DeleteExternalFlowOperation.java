 ...
 */
public class DeleteExternalFlowOperation extends AbstractSectionChangeOperation<ExternalFlowEditPart> {
	 ...
	 *            {@link SectionChanges}.
	 */
	public DeleteExternalFlowOperation(SectionChanges sectionChanges) {
		super("Delete external flow", ExternalFlowEditPart.class, sectionChanges);
	}
