...
/**
 * {@link TeamSourceExtension} for the {@link ThreadLocalAwareTeamSource}.
 * 
 * @author Daniel Sagenschneider
 */
public class ThreadLocalAwareTeamSourceExtension implements TeamSourceExtension<ThreadLocalAwareTeamSource> {
	...
	public String getTeamSourceLabel() {
		return "Thread Local Aware Team";
	}
	...
	public void createControl(Composite page, TeamSourceExtensionContext context) {
		...
		new Label(page, SWT.NONE)
				.setText("No properties required for " + ThreadLocalAwareTeamSource.class.getSimpleName());
	}
