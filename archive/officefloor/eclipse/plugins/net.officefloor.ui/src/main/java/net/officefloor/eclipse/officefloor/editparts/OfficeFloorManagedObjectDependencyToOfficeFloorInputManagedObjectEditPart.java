...
import net.officefloor.model.officefloor.OfficeFloorManagedObjectDependencyToOfficeFloorInputManagedObjectModel.OfficeFloorManagedObjectDependencyToOfficeFloorInputManagedObjectEvent;
 ...
 */
public class OfficeFloorManagedObjectDependencyToOfficeFloorInputManagedObjectEditPart
		extends
		AbstractOfficeFloorConnectionEditPart<OfficeFloorManagedObjectDependencyToOfficeFloorInputManagedObjectModel, OfficeFloorManagedObjectDependencyToOfficeFloorInputManagedObjectEvent>
		implements
		OfficeFloorManagedObjectDependencyToOfficeFloorInputManagedObjectFigureContext {
