...
import net.officefloor.eclipse.woof.editparts.WoofSecurityOutputEditPart;
import net.officefloor.eclipse.woof.editparts.WoofSecurityOutputToWoofResourceEditPart;
import net.officefloor.eclipse.woof.editparts.WoofSecurityOutputToWoofSectionInputEditPart;
import net.officefloor.eclipse.woof.editparts.WoofSecurityOutputToWoofTemplateEditPart;
...
import net.officefloor.eclipse.woof.editparts.WoofSectionOutputToWoofSecurityEditPart;
...
import net.officefloor.eclipse.woof.editparts.WoofTemplateOutputToWoofSecurityEditPart;
...
import net.officefloor.eclipse.woof.operations.AddSecurityOperation;
...
import net.officefloor.eclipse.woof.operations.DeleteSecurityOperation;
...
public class WoofEditor extends AbstractOfficeFloorEditor<WoofModel, WoofChanges> {
	...
	protected void populateEditPartTypes(Map<Class<?>, Class<? extends EditPart>> map) {
		...
		map.put(WoofAccessModel.class, WoofSecurityEditPart.class);
		map.put(WoofAccessInputModel.class, WoofAccessInputEditPart.class);
		map.put(WoofAccessOutputModel.class, WoofSecurityOutputEditPart.class);
		...
		map.put(WoofTemplateOutputToWoofAccessInputModel.class, WoofTemplateOutputToWoofSecurityEditPart.class);
		...
		map.put(WoofSectionOutputToWoofAccessInputModel.class, WoofSectionOutputToWoofSecurityEditPart.class);
		map.put(WoofSectionOutputToWoofResourceModel.class, WoofSectionOutputToWoofResourceEditPart.class);
		map.put(WoofAccessOutputToWoofTemplateModel.class, WoofSecurityOutputToWoofTemplateEditPart.class);
		map.put(WoofAccessOutputToWoofSectionInputModel.class, WoofSecurityOutputToWoofSectionInputEditPart.class);
		map.put(WoofAccessOutputToWoofResourceModel.class, WoofSecurityOutputToWoofResourceEditPart.class);
	...
	protected void populateOperations(List<Operation> list) {
		...
		// Access actions
		list.add(new AddSecurityOperation(woofChanges));
		list.add(new RefactorSecurityOperation(woofChanges));
		list.add(new DeleteSecurityOperation(woofChanges));
